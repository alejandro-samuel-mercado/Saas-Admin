...
export type SaleMode = 'VENTA' | 'ALQUILER' | 'AMBOS';
export type StorefrontLayout = 'standard' | 'property';

export interface RubroProductFormConfig {
  showNutritionalInfo?: boolean;
  showSaleMode?: boolean;
  variantsSuggested?: string[];
  productLabel?: string;
...
export interface Rubro {
  ...
  productFormConfig?: RubroProductFormConfig;
  isActive: boolean;
  createdAt?: string;
  updatedAt?: string;
}
